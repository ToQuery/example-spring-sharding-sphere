...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query(value = """
            select
            new io.github.toquery.example.spring.sharding.sphere.jpa.bff.open.order.model.response.OrderUserResponse(o.id, o.userId, u.username, u.pwd, o.addressId, o.orderStatus, o.createDateTime)
            from Order o 
